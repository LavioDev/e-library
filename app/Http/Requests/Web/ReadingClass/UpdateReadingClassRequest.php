...
class UpdateReadingClassRequest extends FormRequest
{
    ...
    {
        /** @var ReadingClass $readingClass */
        $readingClass = $this->route('readingClass');

        return [
            'name' => ['required', 'string', 'max:255', Rule::unique('reading_classes', 'name')->ignore($readingClass->id)],
