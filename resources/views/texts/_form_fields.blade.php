<div class="grid gap-4 md:grid-cols-2">
    <div class="space-y-2">
        <label for="{{ $prefix }}_text_topic_id" class="block text-sm font-medium text-slate-700">Loại văn bản</label>
        <select
    ...
    <div class="space-y-2">
        <label for="{{ $prefix }}_difficulty" class="block text-sm font-medium text-slate-700">Mức độ</label>
        <select
    ...
    <div class="space-y-2 md:col-span-2">
        <label for="{{ $prefix }}_name" class="block text-sm font-medium text-slate-700">Tên văn bản</label>
        <input
            id="{{ $prefix }}_name"
            type="text"
            name="name"
    ...
    <div class="space-y-2">
        <label for="{{ $prefix }}_topic" class="block text-sm font-medium text-slate-700">Chủ đề</label>
        <input
            id="{{ $prefix }}_topic"
            type="text"
            name="topic"
    ...
    <div class="space-y-2">
        <label for="{{ $prefix }}_author" class="block text-sm font-medium text-slate-700">Tác giả</label>
        <input
            id="{{ $prefix }}_author"
            type="text"
            name="author"
    ...
    <div class="space-y-2 md:col-span-2">
        <label for="{{ $prefix }}_read_link" class="block text-sm font-medium text-slate-700">Link đọc</label>
        <input
