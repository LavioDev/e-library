    ...
    <section class="space-y-5">
        ...
        @else
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-10">
                <div class="md:col-span-3 h-fit overflow-hidden rounded-sm border border-slate-200 bg-white shadow-[0_18px_44px_-36px_rgba(15,23,42,0.35)]">
                ...
                <div class="md:col-span-7 min-w-0 rounded-sm border border-slate-200 bg-white p-5 shadow-[0_18px_44px_-36px_rgba(15,23,42,0.35)]">
